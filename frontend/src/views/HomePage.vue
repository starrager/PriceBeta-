...
<main class="home">
    ...
    <button class="login-button1" @click="router.push('/login')">Sign in</button>
    <button class="login-button" @click="router.push('/register')">Sign up</button>
    <button v-if="isLoggedIn" class="login-button2" @click="logout()">Exit</button>
    </header>
    <section class="hero">
...
const logout=async()=>{
    try{
        ...
        toast.error('server error please repeat later')
    }
}
